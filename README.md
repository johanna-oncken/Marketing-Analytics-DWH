...
**2. Instagram Ads is the most consistent performer across all metrics.** Lowest CPM, best CPM-to-CVR efficiency ratio, strongest April BOFU closing rate (+28.7% CVR MoM) and fastest repeat-purchase conversion paths. LTV:CAC of 3.3 places it just behind Google Display (3.4). Instagram is the only paid channel that performs in the top tier across cost efficiency, closing, retention, and LTV:CAC ratio — though at lower volume than other channels.
