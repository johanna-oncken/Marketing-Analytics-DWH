...
<p><strong>📍 About</strong>This demo project is intended to <strong>showcase skills</strong> and uses <strong>synthetically generated data</strong>.</p>
<p><b>Repository Structure</b></p>
<pre>
Marketing-Analytics-DWH/
│
├── datasets/
