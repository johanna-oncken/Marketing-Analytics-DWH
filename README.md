...
<p>Example visualisation demonstrating the data flow for gold.fact_attribution_linear_with_costs table (to see the full <strong>Data Flow Document</strong>, click on the image):</p>
