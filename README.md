...
<p>Example visualisation demonstrating the data flow for gold.fact_attribution_linear_with_costs table (to see the Full Data Flow Document, click on the image:</p>
