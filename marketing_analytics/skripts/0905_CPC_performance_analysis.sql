...
Queries: 
    ...
    3.1) Monthly CPC Performance and MOM Analysis by Channels 
    3.2) Top Ten Channels by Monthly CPC Improvements 
    3.3) Top Ten Channels by Monthly CPC Declines
    4.1) Monthly CPC Performance and MOM Analysis by Campaigns 
    4.2) Top Ten Campaigns by Monthly CPC Improvements 
    4.3) Top Ten Campaigns by Monthly CPC Declines 
...
-- 3.2) Top 10 Improvements MoM CPC channels
SELECT TOP 10 *
FROM gold.channels_cpc
...
-- 3.3) Top 10 Declines MoM cpc channels
SELECT TOP 10 *
FROM gold.channels_cpc
WHERE diff_pm_cpc IS NOT NULL
...
-- 4.2) Top 10 Improvements MoM CPC campaigns
SELECT TOP 10 *
FROM gold.campaigns_cpc
WHERE diff_pm_cpc IS NOT NULL
ORDER BY diff_pm_cpc ASC; 
...
-- 4.3) Top 10 Declines MoM CPC campaigns
SELECT TOP 10 *
FROM gold.campaigns_cpc
WHERE diff_pm_cpc IS NOT NULL
ORDER BY diff_pm_cpc DESC; 
